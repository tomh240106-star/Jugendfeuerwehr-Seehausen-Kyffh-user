...
class _MemberRecordEditorState extends State<_MemberRecordEditor> {
  ...
  void initState() {
    ...
    groupMovementAllowed = _nullableBool(record['group_movement_allowed']);
    swimmingAllowed = _nullableBool(record['swimming_allowed']);
    swimmingLevel = _nullableString(record['swimming_level']);
    mediaRecordingAllowed = _nullableBool(record['media_recording_allowed']);
    mediaPublicationAllowed = _nullableBool(record['media_publication_allowed']);
  }
  ...
  Widget boolChoice({
    ...
    final current = value == true ? 'yes' : value == false ? 'no' : 'unset';
      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: const Row(
              children: [
                Icon(Icons.badge_outlined, color: Colors.white, size: 30),
                SizedBox(width: 12),
                Expanded(
                  child: Text(
          ...
          infoValue('Vorname', firstName),
          infoValue('Name', lastName),
          dateTile(
            'Geburtsdatum',
            birthDate,
            () async {
          ...
          contactCard(number: 1, name: emergencyName, phone: emergencyPhone),
          contactCard(number: 2, name: emergencyName2, phone: emergencyPhone2),
          contactCard(number: 3, name: emergencyName3, phone: emergencyPhone3),
          contactCard(number: 4, name: emergencyName4, phone: emergencyPhone4),
          ...
          field(homeWayNotes, 'Bemerkung Heimweg', maxLines: 3),
          ...
          stringChoice(
            ...
            onChanged: (value) => setState(() => swimmingLevel = value),
          ),
          ...
          section('Stand des Stammblatts', icon: Icons.update_outlined),
          dateTile(
            'Stand',
            recordAsOf,
            () async {
          ...
          section(
            ...
            subtitle: 'Bisherige App-Felder bleiben erhalten',
          ),
          field(
            email,
          ...
          section('Erziehungsberechtigte', icon: Icons.family_restroom),
          ...
          section('Interne Bemerkungen', icon: Icons.notes_outlined),
          ...
          FilledButton.icon(
            ...
            label: Text(
              saving ? 'Speichern...' : 'Stammblatt speichern',
            ),
          ),
