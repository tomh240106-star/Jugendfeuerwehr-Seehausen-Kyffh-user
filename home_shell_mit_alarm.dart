          ...
          Padding(
            ...
            child: Column(
              children: [
                if (_canUseAlarm) ...[
                  _FeatureCard(
                    background: const Color(0xFFB3000C),
                    icon: Icons.notifications_active,
                    eyebrow: 'JUGENDFEUERWEHR-ALARM',
                    title: 'Alarm & Rückmeldung',
                    subtitle: _isTrainer
                        ? 'Alarm auslösen und Rückmeldungen der Jugendmitglieder sehen.'
                        : 'Auf aktive Alarme mit deiner Ankunftszeit antworten.',
                ...
                _MoreSection(
                  ...
                  children: [
                    ...
                    _MoreTile(
                      icon: Icons.groups_outlined,
                      title: 'Mitglieder',
                      subtitle: 'Profile und Verknüpfungen',
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (_) => const MembersScreen(),
          ...
          : ListView(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  subtitle: const Text(
                    'Benachrichtigungen für Termine, Nachrichten und Dokumente',
                  ),
